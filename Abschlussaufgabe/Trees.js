...
(function (Endabgabe) {
    class Tree extends Endabgabe.DrawObject {
        ...
        draw() {
            ...
            Endabgabe.crc2.fillRect(this.xP, this.yP, this.xD, this.yD);
            Endabgabe.crc2.fillRect(this.xP + 200, this.yP, this.xD, this.yD);
            Endabgabe.crc2.fillRect(this.xP + 100, this.yP - 30, this.xD - 2, this.yD);
            Endabgabe.crc2.fillRect(this.xP + 400, this.yP + 150, this.xD - 2, this.yD);
            Endabgabe.crc2.fill();
        }
    }
    Endabgabe.Tree = Tree;
